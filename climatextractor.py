...
class SILO():
    ...
    def load_cdf_file(self, sourcepath, data_category):
        ...
        value_array = darr.from_array(data_handle.variables[data_category], chunks=data_handle.variables[data_category].shape)
        ...
        for year in year_range:
            ...
            for lat in lat_range:
                ...
                for lon in lon_range:
                    ...
                    self.logger.verbose('Processing {} --> Lat {} - Lon {} for year {}'.format(variable_short_name, lat, lon, file_year))
